...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            <form id="form-data" class="form" action="{{ route('dashboard.password.update') }}"
                enctype="multipart/form-data">
                <div class="card-body border-top p-9">
                    <div class="row mb-6">
                        <label
                            class="col-lg-4 col-form-label required fw-bold fs-6">{{ __('dash.current_password') }}</label>
                    ...
                    <div class="row mb-6">
                        <label
                            class="col-lg-4 col-form-label required fw-bold fs-6">{{ __('dash.password_confirmation') }}</label>
                        <div class="col-lg-8 fv-row">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route('dashboard.home') }}" type="reset"
                        class="btn btn-light btn-active-light-primary me-2">{{ __('dash.discard') }}</a>
